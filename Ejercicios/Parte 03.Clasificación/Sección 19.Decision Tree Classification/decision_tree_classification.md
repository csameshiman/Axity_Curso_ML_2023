...
```python
# Entrenar el clasificador de Árbol de Decisión con el Conjunto de Entrenamiento
...
![png](../../imagenes/decision_tree_classification_8_0.png)
...
![png](../../imagenes/decision_tree_classification_9_0.png)
