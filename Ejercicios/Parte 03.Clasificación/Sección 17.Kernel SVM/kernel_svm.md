...
classifier = SVC(kernel = "rbf", random_state = 0) #linear', 'poly', 'rbf', 'sigmoid', 'precomputed'}, default = 'rbf'
...
![png](../../imagenes/kernel_svm_8_0.png)
...
![png](../../imagenes/kernel_svm_9_0.png)
